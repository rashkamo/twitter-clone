...
function Sidebar() {
  ...
  return (
    <div className="relative ">
      <div className="hidden sm:flex flex-col sm:items-start items-center xl:items-start xl:w-[340px] p-2 sm:fixed h-full ">
        ...
        >
          ...
          <div className="hidden xl:inline leading-5">
            ...
            <p className="text-[#6e76ed]">@{session.user.tag}</p>
          </div>
