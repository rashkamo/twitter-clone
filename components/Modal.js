...
function Modal() {
  ...
  //data(); we use it to get single doc
  useEffect(
    () =>
            ...
            <div className="inline-block align-bottom bg-black rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-xl sm:w-full">
              ...
              <div className="flex px-4 pt-5 pb-2.5 sm:px-6">
                <div className="w-full">
                  <div className="text-[#6e767d] flex gap-x-2 relative">
                    ...
                    <div>
                      <div className="inline-block group">
                        ...
                        .{" "}
                        <span className="hover:underline text-sm sm:text-[12px] font-bold">
                  ...
                  <div className="mt-7 flex space-x-3 w-full">
                    ...
                    <div className="flex-grow mt-2">
                      <textarea
                        ...
                        rows="2"
                        className="bg-transparent outline-none text-[#d9d9d9] text-[15px] placeholder-gray-500 tracking-wide w-full min-h-[80px]"
                      />
